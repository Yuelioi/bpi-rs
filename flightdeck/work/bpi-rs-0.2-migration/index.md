...
Current:
- Shared-core/domain bridge work has completed `clientinfo/module-client-bridge`, `web_widget/module-client-bridge`, `activity/module-client-bridge`, `wallet/module-client-bridge`, `opus/module-client-bridge`, and `misc/module-client-bridge` examples after endpoint contract batches.
